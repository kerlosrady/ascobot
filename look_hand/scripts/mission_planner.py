			...
			if self.state==3 and self.cans_detected == True and self.head_state==2:
				...
				while (self.done is not True):
					...
					if self.execute_state ==1 :
						...
						apose_goal1[1]=self.finalPoints.poses[0].position.y + 0.0346
						...
						apose_goal2[1]=self.finalPoints.poses[1].position.y + 0.0346
					...
					if self.execute_state==6 and self.head_state==3 and self.shelf_detected==True and self.torso_down==1:
						...
						apose_goal1[2]=self.finalPoints.poses[0].position.z +0.13
						apose_goal1[3]=2
						...
						apose_goal2[2]=self.finalPoints.poses[1].position.z +0.13
						apose_goal2[3]=2
						pose_goal2= Float32MultiArray(data =apose_goal2 )
						rospy.sleep(1)	
